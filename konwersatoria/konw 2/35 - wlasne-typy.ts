...
type CityLatLong2 = (string | number)[]
const krakow: CityLatLong = ['Kraków', 50.049683, 19.944544]
const cityName = krakow[0]
// tuple z etykietami:
...
function filtrujTekst(ff: FilterFunction, data: string[]) {
  return data.filter(el => ff(el))
}
const wszystkieNaA = (value: string) => {
...
// const permissions: SmarterPermTypes[] = [SmarterPermTypes.exec, SmarterPermTypes.read]
